...
class ReportGeneratorServiceImplTest {
    private static ReportGeneratorServiceImpl reportInfoService;
    ...
    @BeforeEach
    void setUp() {
        reportInfoService = new ReportGeneratorServiceImpl();
    }
    ...
    void reportInfo_ValidData_ok() {
        ...
        String actual = reportInfoService.generateReport();
