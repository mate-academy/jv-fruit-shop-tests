...
class ReaderServiceImplTest {
    private static final String EMPTY_PATH = "src/test/java/resources/empty.csv";
    private static final String TITLE_PATH = "src/test/java/resources/title.csv";
    private static final String ACTIVITIES_PATH = "src/test/java/resources/storeActivities.csv";
    private static final String WRONG_PATH_1 = "src/test/java/resources/store.csv";
    private static final String WRONG_PATH_2 = "src/test/java/storeActivities.csv";
