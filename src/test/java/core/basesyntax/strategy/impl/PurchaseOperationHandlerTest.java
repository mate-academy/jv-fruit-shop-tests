...
public class PurchaseOperationHandlerTest {
    ...
    public void apply_addCorrectValueToStorage_ok() {
        Integer expected = 80;
        operationHandler.apply(new FruitTransaction(PURCHASE, "banana", VALID_VALUE));
    ...
    public void apply_addDataWithNullKey_ok() {
        operationHandler.apply(new FruitTransaction(PURCHASE, null, VALID_VALUE));
    ...
    public void apply_addDataWithEmptyKey_ok() {
        operationHandler.apply(new FruitTransaction(PURCHASE, "", VALID_VALUE));
