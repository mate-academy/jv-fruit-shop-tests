...
public class Main {
    private static final Path DEFAULT_INPUT_PATH = Paths.get("src/main/resources/inputData.csv");
    private static final Path DEFAULT_OUTPUT_PATH = Paths.get("src/main/resources/outputData.csv");
