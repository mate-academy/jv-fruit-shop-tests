...
public class OperationStrategyImplTest {
    ...
    public void operationStrategyImpl_returnBalanceOperation_Ok() {
        Class actual = new OperationStrategyImpl(activityOperationMap).get(FruitTransaction.Activity.BALANCE).getClass();
    ...
    public void operationStrategyImpl_returnPurchaseOperation_Ok() {
        Class actual = new OperationStrategyImpl(activityOperationMap).get(FruitTransaction.Activity.PURCHASE).getClass();
    ...
    public void operationStrategyImpl_returnReturnOperation_Ok() {
        Class actual = new OperationStrategyImpl(activityOperationMap).get(FruitTransaction.Activity.RETURN).getClass();
    ...
    public void operationStrategyImpl_returnSupplyOperation_Ok() {
        Class actual = new OperationStrategyImpl(activityOperationMap).get(FruitTransaction.Activity.SUPPLY).getClass();
