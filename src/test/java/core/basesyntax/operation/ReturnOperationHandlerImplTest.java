...
class ReturnOperationHandlerImplTest {
    ...
    static void beforeAll() {
        ...
        transaction = new FruitTransaction(Operation.RETURN,FRUIT_NAME, OPERATION_FRUIT_QUANTITY);
    }

    @BeforeEach
    void setUp() {
        balanceOperationHandler = new ReturnOperationHandlerImpl(fruitQuantityDao);
    }
