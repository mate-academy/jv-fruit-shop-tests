...
public class Main {
    private static final String FILE_PATH_FROM = "src/main/java/resources/file.csv";
    private static final String FILE_PATH_TO = "src/main/java/resources/report.csv";
