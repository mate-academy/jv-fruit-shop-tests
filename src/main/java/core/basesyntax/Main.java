...
import core.basesyntax.service.DataToFileWriter;
import core.basesyntax.service.DataToFileWriterImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        DataToFileWriter dataToFileWriter = new DataToFileWriterImpl();
        dataToFileWriter.writeData(report, "src/main/resources/finalReport.csv");
    }
}
