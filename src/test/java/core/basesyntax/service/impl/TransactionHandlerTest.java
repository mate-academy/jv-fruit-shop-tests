...
class TransactionHandlerTest {
    ...
    void balanceTransactionValid() {
        ...
        FruitTransaction transaction = new FruitTransaction(Operation.BALANCE, apple, appleForBalance);
    ...
    void purchaseTransactionValid() {
        ...
        FruitTransaction transaction = new FruitTransaction(Operation.PURCHASE, apple, appleForPurchase);
    ...
    void supplyTransactionValid() {
        ...
        FruitTransaction transaction = new FruitTransaction(Operation.SUPPLY, apple, appleForSupply);
    ...
    void returnTransactionValid() {
        ...
        FruitTransaction transaction = new FruitTransaction(Operation.RETURN, apple, appleForReturn);
