...
public class BalanceTransactionHandlerTest {
    ...
    public static void beforeClass() {
        transactionHandler = new BalanceTransactionHandler(new FruitStorageDaoImpl());
    }

    @Test
    public void balanceWithEmptyStorage_ok() {
        transactionHandler.apply(new FruitTransaction("b", "banana", 5));
    ...
    public void balanceWithNotEmptyStorage_ok() {
        ...
        transactionHandler.apply(new FruitTransaction("b", "apple", 5));
