...
class SupplyOperationHandlerImplTest {
    ...
    static void beforeAll() {
        ...
        transaction = new FruitTransaction(Operation.SUPPLY,FRUIT_NAME, OPERATION_FRUIT_QUANTITY);
    }

    @BeforeEach
    void setUp() {
        balanceOperationHandler = new SupplyOperationHandlerImpl(fruitQuantityDao);
    }
