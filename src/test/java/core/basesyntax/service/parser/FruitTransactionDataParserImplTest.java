...
class FruitTransactionDataParserImplTest {
    private static final String FOURTH_FRUIT_NAME = "Lemon";
    private static final int FIRST_FRUIT_QUANTITY = 10;
    private static final int SECOND_FRUIT_QUANTITY = 15;
    private static final int THIRD_FRUIT_QUANTITY = 20;
    private static final int FOURTH_FRUIT_QUANTITY = 25;
    private static final int AMOUNT_OF_FRUIT_TRANSACTIONS = 4;
    private static final String FIRST_FRUIT_NAME = "Apple";
    private static final String SECOND_FRUIT_NAME = "Banana";
    private static final String THIRD_FRUIT_NAME = "Peach";
    private static final int FIRST_FRUIT_INDEX = 0;
    private static final int SECOND_FRUIT_INDEX = 1;
    private static final int THIRD_FRUIT_INDEX = 2;
    private static final int FOURTH_FRUIT_INDEX = 3;
