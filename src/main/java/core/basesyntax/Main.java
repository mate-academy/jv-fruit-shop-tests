...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> inputReport = fileReader.readFile("src/test/resources/reportToRead.csv");
        ...
        fileWriter.writeToFile(resultingReport, "src/test/resources/finalReport.csv");
    }
}
