...
public class FruitShopApp {
    ...
    private static final String CSV_PATH = RESOURCES_PATH
            + "CSV.csv";
    private static final String WRONG_QUANTITY_CSV = RESOURCES_PATH
            + "WRONG_QUANTITY_CSV.csv";
    private static final String WRONG_SUMMARY_VALUE_CSV = RESOURCES_PATH
