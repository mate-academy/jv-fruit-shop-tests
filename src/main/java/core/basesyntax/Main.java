...
public class Main {
    ...
    public static void main(String[] arg) {
        ...
        operationHandler.put(Operation.BALANCE, new BalanceOperation());
        operationHandler.put(Operation.PURCHASE, new PurchaseOperation());
        operationHandler.put(Operation.RETURN, new ReturnOperation());
        operationHandler.put(Operation.SUPPLY, new SupplyOperation());
