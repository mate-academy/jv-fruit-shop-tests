...
public class OperationStrategyImplTest {
    ...
    @Test
    public void getOperationType_balance_ok() {
    ...
    @Test
    public void getOperationType_supply_ok() {
    ...
    @Test
    public void getOperationType_purchase_ok() {
    ...
    @Test
    public void getOperationType_return_ok() {
