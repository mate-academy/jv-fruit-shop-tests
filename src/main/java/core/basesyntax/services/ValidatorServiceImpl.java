...
public class ValidatorServiceImpl implements ValidatorService {
    ...
    @Override
    public void emptyInputDataValidator(List<String> inputData) {
    ...
    @Override
    public void nullInputDataValidator(String fileName) {
        if (fileName == null) {
            throw new ValidationException("Please use correct file name");
        }
    }
}
