...
public class FruitShopServiceImpl implements FruitShopService {
    ...
    @Override
    public List<FruitTransaction> readAllFromCsv(String readFilePath) {
    ...
    @Override
    public void exportReport(String writeFilePath) {
    ...
    @Override
    public FruitTransaction mapToFruitTransaction(String row) {
    ...
    @Override
    public List<String> generateReport(Map<String, Integer> storageMap) {
