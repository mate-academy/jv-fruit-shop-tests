...
public class OperationServiceTest {
    ...
    public void executeTransaction_NullTransactions_NotOk() {
        operationService.executeTransactions(null);
    }
    ...
    @Test
    public void executeTransaction_PutThenUpdateBalanceTransaction_Ok() {
    ...
    @Test
    public void executeTransaction_PutThenUpdateReturnTransaction_Ok() {
    ...
    @Test
    public void executeTransaction_PutThenUpdateSupplyTransaction_Ok() {
    ...
    @Test
    public void executeTransaction_PurchaseOperationSufficientStock_Ok() {
        testTransaction.setOperation(FruitTransaction.Operation.BALANCE);
        List<FruitTransaction> transactions = List.of(testTransaction);
        operationService.executeTransactions(transactions);
