...
class ReturnOperationHandlerTest {
    ...
    @Test
    void getReturnWithNewFruitOrNull_notOk() {
        FruitTransaction fruitTransactionNull = null;
        FruitTransaction newFruit = new FruitTransaction(FruitTransaction.Operation
                .SUPPLY, "new fruit", 10);
