...
public class ReadFromFileImplTest {
    ...
    private static final String EMPTY_FILE = "src/test/java/core/"
            + "basesyntax/resourses/empty.csv";
    ...
    public void readFromEmptyFile() {
        List<String> actualResult = reader.readFile(EMPTY_FILE);
        assertEquals(EMPTY_RESULT, actualResult);
    }
