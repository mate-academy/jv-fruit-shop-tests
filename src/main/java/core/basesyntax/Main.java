...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<FruitTransaction> transactions = transactionParser.parse(lines);
        ...
        ReportService reportCreator = new ReportServiceImpl();
        WriterServiceImpl fileWriter = new WriterServiceImpl();
        fileWriter.writeToFile(reportCreator.createReport(), REPORT_FILE_NAME);
    }
}
