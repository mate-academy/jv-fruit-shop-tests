...
public class FileServiceTest {
    private static final String DEFAULT_FILE_PATH = "src/test/resources/defaultFile";
    ...
    public void readFromFile_readData_Ok() {
        ...
        String actual = fileService.readFromFile(DEFAULT_FILE_PATH);
        assertEquals(expected, actual);
    }

    @Test
    public void readFromFile_emptyValue_Ok() {
        FileService fileService = new FileServiceImpl();
    ...
    @Test
    public void writeToFile_firstCase_Ok() {
        FileService fileService = new FileServiceImpl();
    ...
    @Test
    public void writeToFile_secondCase_Ok() {
        FileService fileService = new FileServiceImpl();
        String data = "test123" + System.lineSeparator();
        String expected = data;
        fileService.writeToFile(FILE_TO_WRITE_NAME, data);
    ...
    @Test
    public void writeToFile_NullValueAndPath_NotOk() {
        FileService fileService = new FileServiceImpl();
        assertThrows(NullPointerException.class,
