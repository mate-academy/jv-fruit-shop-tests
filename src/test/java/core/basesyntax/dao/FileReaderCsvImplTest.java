...
public class FileReaderCsvImplTest {
    ...
    @Test
    public void readFromFile_Ok() throws Exception {
    ...
    @Test
    public void readFromFile_emptyFile_Ok() throws Exception {
    ...
    @Test
    public void readFromFile_NonExistentFileExceptionMessage_Ok() {
