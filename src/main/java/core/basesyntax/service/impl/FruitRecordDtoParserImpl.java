...
public class FruitRecordDtoParserImpl implements FruitRecordDtoParser {
    ...
    public List<FruitRecordDto> parse(List<String> lines) {
        ...
        for (String line:lines) {
            ...
            if (validationData.validationData(lineSplit[OPERATION_TYPE_ELEMENT],
                    lineSplit[FRUIT_NAME_ELEMENT], lineSplit[FRUIT_COUNT_ELEMENT])) {
                FruitRecordDto dto = new FruitRecordDto(OperationType
                        .valueOf(lineSplit[OPERATION_TYPE_ELEMENT].trim()),
                        lineSplit[FRUIT_NAME_ELEMENT],
