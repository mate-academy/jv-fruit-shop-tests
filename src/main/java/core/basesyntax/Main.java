...
public class Main {
    private static final String FROM_FILE_PATH = "src/main/java/core/basesyntax/resources/fruitsInfo.csv";
    private static final String TO_FILE_PATH = "src/main/java/core/basesyntax/resources/report.csv";
