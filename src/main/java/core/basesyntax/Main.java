...
public class Main {
    public static final String READ_FILE_PATH = "src/main/java/resources/file.txt";
    public static final String REPORT_FILE_PATH = "src/main/java/resources/report.txt";
