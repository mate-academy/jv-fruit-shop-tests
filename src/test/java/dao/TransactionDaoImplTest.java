...
class TransactionDaoImplTest {
    ...
    void saveTransaction_WhenNewTransaction_StoresCorrectly() {
        ...
        assertEquals(2,
                ...
                "Storage should contain 2 items");
        assertEquals(15,
                allTransactions.get("Apple"),
                "Apple should have 15 quantity");
        assertEquals(10,
                allTransactions.get("Banana"),
                "Banana should have 10 quantity");
    }
    ...
    void getTransactionByName_WhenFruitExists_ReturnsCorrectQuantity() {
        transactionDao.saveTransaction("Apple",
                25);
        assertEquals(25,
                transactionDao.getTransactionByName(
                        "Apple"),
    ...
    void clearTransactions_WhenCalled_EmptiesStorage() {
        ...
        transactionDao.saveTransaction("Banana",
                10);
        transactionDao.clearTransactions();
        assertTrue(transactionDao.getAll()
                        .isEmpty(),
