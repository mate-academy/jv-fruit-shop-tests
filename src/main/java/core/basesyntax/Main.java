...
public class Main {
    private static final String READ_FILE_PATH = "src/main/java/resources/data.csv";
    private static final String WRITE_FILE_PATH = "src/main/java/resources/report.csv";
