...
public class Main {
    private static final String READ_FILE_PATH = "src/main/java/resources/FruitStore_Data.csv";
    private static final String WRITE_FILE_PATH = "src/main/java/resources/FruitStore_Report.csv";
    ...
    public static void main(String[] args) {
        ...
        Map<Transaction.Operation, OperationHandler> operationHandlers = Map.of(
