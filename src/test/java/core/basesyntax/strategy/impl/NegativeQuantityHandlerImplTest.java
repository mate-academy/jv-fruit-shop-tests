...
public class NegativeQuantityHandlerImplTest {
    private static final QuantityHandler quantityHandler = new NegativeQuantityHandlerImpl();
    ...
    public void getQuantity_nullFruit_NotOk() {
        ...
        quantityHandler.getQuantity(new FruitTransaction(Operation.PURCHASE, null));
    }
    ...
    public void getQuantity_nullFruitName_NotOk() {
        ...
        quantityHandler.getQuantity(new FruitTransaction(Operation.PURCHASE, new Fruit(null, 20)));
    }
