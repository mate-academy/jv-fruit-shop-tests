...
class OperationProcessTest {
    ...
    static void beforeAll() {
        Map<FruitTransaction.Operation, OperationHandler> handlerMap
                = Map.of(FruitTransaction.Operation.BALANCE, new BalanceHandler(fruitDao),
                FruitTransaction.Operation.PURCHASE, new PurchaseHandler(fruitDao),
                FruitTransaction.Operation.RETURN, new ReturnHandler(fruitDao),
                FruitTransaction.Operation.SUPPLY, new SupplyHandler(fruitDao));
