...
class ReturnOperationHandlerTest {
    ...
    private static FruitTransaction fruitTransactionReturnApple;
    ...
    void processTransaction_transactionIsCorrect_Ok() {
        operationHandler.processTransaction(fruitTransactionReturnBanana);
        assertEquals(QUANTITY_BANANA, Storage.storage.get("banana"));
        operationHandler.processTransaction(fruitTransactionReturnApple);
