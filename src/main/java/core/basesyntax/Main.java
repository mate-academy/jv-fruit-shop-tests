...
public class Main {
    private static final String INPUT_FILE_PATH = "src/main/resources/test1";
    private static final String OUTPUT_FILE_ENDING = "_report";
    ...
    public static void main(String[] args) {
        ...
        List<String> records = reader.read(INPUT_FILE_PATH);
        ...
        writer.write(report, INPUT_FILE_PATH + OUTPUT_FILE_ENDING);
    }
}
