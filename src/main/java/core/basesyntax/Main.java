...
public class Main {
    private static final String READ_FROM_PATH = "src/main/java/resources/inputFileExample.csv";
    private static final String WRITE_TO_PATH = "src/main/java/resources/outputFileExample.csv";
    ...
    public static void main(String[] args) {
        ...
        List<String> dayStatistics = readerService.readFromFile(READ_FROM_PATH);
        ...
        writerService.writeToFile(report, WRITE_TO_PATH);
    }
}
