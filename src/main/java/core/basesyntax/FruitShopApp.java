...
public class FruitShopApp {
    private static final String FILE_TO_READ_PATH = "src/main/java/resources/reportToRead.csv";
    private static final String FINAL_REPORT_FILE_PATH = "src/main/java/resources/finalReport.csv";
