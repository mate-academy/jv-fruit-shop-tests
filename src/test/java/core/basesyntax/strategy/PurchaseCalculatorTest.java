...
public class PurchaseCalculatorTest {
    private static TypeCalculatorStrategy purchase;
    private static FruitTransaction fruitTransaction;
    private static FruitTransaction invalidTransaction;

    @BeforeClass
    public static void beforeClass() {
        purchase = new PurchaseCalculatorImpl();
        fruitTransaction = new FruitTransaction(FruitTransaction.Operation.PURCHASE, "banana", 10);
        invalidTransaction = new FruitTransaction(FruitTransaction.Operation.SUPPLY, "banana", 10);
    }
