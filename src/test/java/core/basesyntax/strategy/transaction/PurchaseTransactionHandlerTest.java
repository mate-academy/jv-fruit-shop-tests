...
class PurchaseTransactionHandlerTest {
    ...
    static void beforeAll() {
        transactionHandler = new PurchaseTransactionHandlerImpl();
    }

    @Test
    void handle_normalPurchaseFruit_ok() {
        Storage.fruitsMap.put(NORMAL_FRUIT_NAME, BALANCE_FRUIT_QUANTITY);
        transactionHandler.handle(transaction);
        Integer actual = Storage.fruitsMap.get(NORMAL_FRUIT_NAME);
