...
class FruitTransactionTest {
    ...
    void setOperation_UpdatesOperationCorrectly() {
        FruitTransaction transaction = new FruitTransaction(FruitTransaction.Operation.BALANCE, "Banana", 50);
    ...
    void setFruit_UpdatesFruitCorrectly() {
        FruitTransaction transaction = new FruitTransaction(FruitTransaction.Operation.BALANCE, "Orange", 30);
    ...
    void setQuantity_UpdatesQuantityCorrectly() {
        FruitTransaction transaction = new FruitTransaction(FruitTransaction.Operation.BALANCE, "Grapes", 20);
