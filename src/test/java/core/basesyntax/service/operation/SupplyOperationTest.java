...
class SupplyOperationTest {
    ...
    private final FruitTransaction.Operation operation = FruitTransaction.Operation.SUPPLY;
    ...
    @Test
    void apply_ReturnSupplyOperation_ToNotExist_Ok() {
        String fruit = "banana";
    ...
    @Test
    void apply_ReturnSupplyOperation_ToExist_Ok() {
        String fruit = "banana";
