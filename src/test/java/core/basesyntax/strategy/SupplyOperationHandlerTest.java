...
public class SupplyOperationHandlerTest {
    ...
    void handle_validTransaction_increasesStorage() {
        ...
        FruitTransaction fruitTransaction = new FruitTransaction(FruitTransaction.Operation.SUPPLY, FRUIT_NAME, SUPPLY_QUANTITY);
    ...
    void handle_invalidTransaction_throwsRuntimeException() {
        FruitTransaction fruitTransactionWithNullFruit = new FruitTransaction(FruitTransaction.Operation.SUPPLY, null, SUPPLY_QUANTITY);
        assertThrows(RuntimeException.class, () -> supplyOperationHandler.handle(fruitTransactionWithNullFruit));

        FruitTransaction fruitTransactionWithNullOperation = new FruitTransaction(null, FRUIT_NAME, SUPPLY_QUANTITY);
        assertThrows(RuntimeException.class, () -> supplyOperationHandler.handle(fruitTransactionWithNullOperation));
    }
