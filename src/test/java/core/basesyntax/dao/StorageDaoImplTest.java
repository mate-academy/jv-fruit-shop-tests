...
public class StorageDaoImplTest {
    ...
    public void getAbsentKey_Exception() {
        storageDao.getAmount("Bob_The_minion");
    }

    @Test(expected = RuntimeException.class)
    public void keyToGetValueIsNull_Ok() {
        String key = null;
        storageDao.getAmount(key);
    }

    @Test
    public void getCorrectValue_True() {
        assertEquals(storageDao.getAmount("apple"), 10);
    }

    @Test(expected = RuntimeException.class)
    public void fruitModelIsNull_Exception() {
    ...
    @Test
    public void testIfFruitModelWasAdded_True() {
    ...
    @Test
    public void replacedCorrect_True() {
