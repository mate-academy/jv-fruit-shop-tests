...
public class ParserImpl implements Parser {
    ...
    private FruitTransaction getFromCsvRow(String line) {
        ...
        if (fields[FRUIT_INDEX].isEmpty() || hasNonWordCharacter(fields[FRUIT_INDEX])) {
            throw new RuntimeException("Invalid fruit name presents in line: " + line);
        }
    ...
    private boolean hasNonWordCharacter(String fruitName) {
        char[] wordInCharArray = fruitName.toCharArray();
        for (char c : wordInCharArray) {
