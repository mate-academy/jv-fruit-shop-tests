...
public abstract class OperationStrategyImpl implements Strategy {
    ...
    public abstract OperationHandler get(Operation operation, Map<Operation, OperationHandler> map);
}
