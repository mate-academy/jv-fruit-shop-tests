...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<FruitTransaction.Operation, OperationHandler> handlersMap = getHandlersMap();
    ...
    private static Map<FruitTransaction.Operation, OperationHandler> getHandlersMap() {
