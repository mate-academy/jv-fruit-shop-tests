 ...
 */
public class Main {
    private static final String fromPath = "src/test/resources/rightInput.csv";
    private static final String toPath = "src/test/resources/dayReport.csv";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Your report wait for you"
                + " in src/test/resources, name as: dayReport.csv");
    }
}
